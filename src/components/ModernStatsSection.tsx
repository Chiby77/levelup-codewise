...
import { Users, BookOpen, Star, Target, GraduationCap } from "lucide-react";
...
const ModernStatsSection = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      description: "Dedicated teaching",
    },
    {
      icon: Target,
      label: "Avg Pass Rate",
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/20 text-emerald-400 text-sm font-semibold mb-4 border border-emerald-500/30">
            <GraduationCap className="w-4 h-4" />
            Our Journey
            <GraduationCap className="w-4 h-4" />
          </div>
          <h2 className="text-4xl md:text-6xl font-black mb-4">
            <span className="bg-gradient-to-r from-emerald-400 via-teal-500 to-blue-500 bg-clip-text text-transparent animate-gradientShift bg-[length:200%_200%]">
              Thank You Zimbabwe!
            </span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto animate-slideUp" style={{ animationDelay: "0.2s" }}>
            To all the teachers and students who trusted us with their Computer Science journey
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                {/* Card */}
                <div className="bg-card/80 backdrop-blur-sm rounded-3xl p-8 border border-border/50 hover:border-accent/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl group-hover:shadow-accent/20 relative overflow-hidden">
        ...
        {/* Platform Migration Notice & Private Lessons CTA */}
        <div className="text-center mt-20 space-y-8 animate-slideUp" style={{ animationDelay: "0.8s" }}>
          {/* Private Lessons Card */}
          <div className="relative inline-block max-w-3xl w-full">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/30 to-teal-500/30 rounded-2xl blur-xl animate-pulse" />
            <div className="relative bg-gradient-to-r from-emerald-600/90 to-teal-600/90 backdrop-blur-sm rounded-2xl p-8 border border-emerald-400/50">
              ...
              <p className="text-white/90 mb-4 max-w-xl mx-auto">
                <span className="text-yellow-300 font-bold">Tinodaishe M. Chibi</span> (CEO, Bluewave Technologies) is available for private A Level Computer Science lessons and school seminars.
              </p>
          ...
          <div className="relative inline-block max-w-3xl w-full">
            ...
            <div className="relative bg-gradient-to-r from-orange-600/90 to-red-600/90 backdrop-blur-sm rounded-2xl p-6 border border-orange-400/50">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3">
                ⚠️ Platform Migration Notice ⚠️
              </h3>
              <p className="text-white/90 max-w-xl mx-auto">
                This platform is <span className="text-yellow-300 font-bold">going offline soon</span> to be replaced with a more stable, fresh version of <span className="text-yellow-300 font-bold">Bluewave Academy</span>. All user accounts will be migrated automatically. Stay tuned! 🚀
              </p>
            </div>
          </div>
        </div>
