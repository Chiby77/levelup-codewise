...
export default function StudentDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/20 via-background to-yellow-900/10">
        <div className="text-center space-y-4">
          <div className="w-16 h-16 border-4 border-primary/30 border-t-transparent rounded-full animate-spin mx-auto" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-yellow-900/5">
      {/* Enhanced Header - Mobile Optimized */}
      <header className="border-b bg-gradient-to-r from-primary/10 via-background/95 to-yellow-600/10 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
            <div className="relative flex-shrink-0">
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 to-primary/80 rounded-lg sm:rounded-xl blur animate-pulse" />
              <div className="relative bg-gradient-to-br from-primary to-primary/80 p-2 sm:p-3 rounded-lg sm:rounded-xl">
                <GraduationCap className="h-5 w-5 sm:h-7 sm:w-7 text-white" />
              </div>
            </div>
            <div className="min-w-0 flex-1">
              <h1 className="text-base sm:text-xl font-bold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent truncate">
                Student Dashboard
              </h1>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/80/10 border-primary/30">
            <CardHeader className="flex flex-row items-center justify-between p-3 sm:p-4 pb-1 sm:pb-2">
              <CardTitle className="text-xs sm:text-sm font-medium text-primary">Avg Score</CardTitle>
              <div className="bg-primary/20 p-1.5 sm:p-2 rounded-lg">
                <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 text-primary" />
              </div>
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="text-2xl sm:text-3xl font-bold text-primary">{stats.avgScore}%</div>
              <p className="text-[10px] sm:text-xs text-primary/70">All exams</p>
            </CardContent>
          </Card>
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 -mx-1 px-1">
          <Button 
            ...
            variant="outline"
            size="sm"
            className="gap-1.5 border-primary/30 hover:bg-primary/10 hover:border-primary/30 whitespace-nowrap flex-shrink-0"
          >
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="gap-1.5 border-primary/40 hover:bg-primary/10 hover:border-primary/40 whitespace-nowrap flex-shrink-0"
          >
        ...
        <Tabs defaultValue="exams" className="space-y-3 sm:space-y-4">
          ...
          <TabsContent value="exams" className="space-y-3">
            <Card className="border-primary/30">
              <CardHeader className="bg-gradient-to-r from-primary to-primary/80 rounded-t-lg p-3 sm:p-6">
                          ...
                          <CardHeader className="p-3 sm:p-4">
                            <div className="flex items-start justify-between gap-2">
                              <div className="space-y-0.5 min-w-0 flex-1">
                                <CardTitle className="text-sm sm:text-lg text-primary truncate">{exam.title}</CardTitle>
                                <CardDescription className="text-xs line-clamp-1">{exam.description}</CardDescription>
                              </div>
                              <Badge className="bg-primary/15 text-primary border-primary/30 text-[10px] sm:text-xs flex-shrink-0">{exam.subject}</Badge>
                            </div>
                          </CardHeader>
                          <CardContent className="p-3 sm:p-4 pt-0">
          ...
          <TabsContent value="resources" className="space-y-3">
            <div className="grid grid-cols-1 gap-3 sm:gap-4">
              <Card className="border-primary/30/50">
                <CardHeader className="bg-gradient-to-r from-primary to-cyan-50 rounded-t-lg p-3 sm:p-6">
                  <div className="flex items-center gap-2">
                    <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
                    <CardTitle className="text-primary text-base sm:text-lg">Study Tips</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-2 sm:p-4">
                  <ScrollArea className="h-[200px] sm:h-[250px]">
                    <div className="space-y-2">
                      {tips.map((tip) => (
                        <Card key={tip.id} className="border-primary/30">
                          <CardHeader className="p-2 sm:p-3 pb-1">
                            <CardTitle className="text-xs sm:text-sm text-primary">{tip.title}</CardTitle>
                            <Badge variant="outline" className="w-fit bg-primary text-primary border-primary/30 text-[10px]">
                              {tip.category}
                            </Badge>
                          </CardHeader>
